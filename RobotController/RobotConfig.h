...
DEFINE_GLOBAL_VARIABLE(int, ANGLE_INTEGRAL_FACTOR, 0)
DEFINE_GLOBAL_VARIABLE(int, MAX_ANGLE_INTEGRAL_SUM_DEG, 100)
...
GlobalVariable globalVariables[] = {
    ...
    DECLARE_GLOBAL_VARIABLE(ANGLE_INTEGRAL_FACTOR),
    DECLARE_GLOBAL_VARIABLE(MAX_ANGLE_INTEGRAL_SUM_DEG),
