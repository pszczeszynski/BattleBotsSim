...
{
    // imagine the robot was orbitting in a circle around the opponent's weapon here (we aren't, but just for defining the path)
    ...
    // calculate the orbit radius given that danger level
