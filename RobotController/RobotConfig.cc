...
DEFINE_GLOBAL_VARIABLE(int, KILL_ANGLE_EXTRAPOLATE_MS, 150)
...
DEFINE_GLOBAL_VARIABLE(int, WALL_BOUNDS_LEFT, 0)
DEFINE_GLOBAL_VARIABLE(int, WALL_BOUNDS_RIGHT, WIDTH)
DEFINE_GLOBAL_VARIABLE(int, WALL_BOUNDS_TOP, 0)
DEFINE_GLOBAL_VARIABLE(int, WALL_BOUNDS_BOTTOM, HEIGHT)
DEFINE_GLOBAL_VARIABLE(int, RADIO_CHANNEL, 60)
...
GlobalVariable globalVariables[] = {
    ...
    DECLARE_GLOBAL_VARIABLE(KILL_ANGLE_EXTRAPOLATE_MS),
    ...
    DECLARE_GLOBAL_VARIABLE(WALL_BOUNDS_LEFT),
    DECLARE_GLOBAL_VARIABLE(WALL_BOUNDS_RIGHT),
    DECLARE_GLOBAL_VARIABLE(WALL_BOUNDS_TOP),
    DECLARE_GLOBAL_VARIABLE(WALL_BOUNDS_BOTTOM),
