...
DEFINE_GLOBAL_VARIABLE(float, RADIUS_CURVE_X0, 0.0f)
DEFINE_GLOBAL_VARIABLE(float, RADIUS_CURVE_X1, 15.0f)
DEFINE_GLOBAL_VARIABLE(float, RADIUS_CURVE_X2, 100.0f)
DEFINE_GLOBAL_VARIABLE(float, RADIUS_CURVE_X3, 200.0f)
DEFINE_GLOBAL_VARIABLE(float, RADIUS_CURVE_Y0, 0.0f)
DEFINE_GLOBAL_VARIABLE(float, RADIUS_CURVE_Y1, 85.0f)
DEFINE_GLOBAL_VARIABLE(float, RADIUS_CURVE_Y2, 150.0f)
DEFINE_GLOBAL_VARIABLE(float, RADIUS_CURVE_Y3, 150.0f)
...
GlobalVariable globalVariables[] = {
    ...
    DECLARE_GLOBAL_VARIABLE(RADIUS_CURVE_X0),
    DECLARE_GLOBAL_VARIABLE(RADIUS_CURVE_X1),
    DECLARE_GLOBAL_VARIABLE(RADIUS_CURVE_X2),
    DECLARE_GLOBAL_VARIABLE(RADIUS_CURVE_X3),
    DECLARE_GLOBAL_VARIABLE(RADIUS_CURVE_Y0),
    DECLARE_GLOBAL_VARIABLE(RADIUS_CURVE_Y1),
    DECLARE_GLOBAL_VARIABLE(RADIUS_CURVE_Y2),
    DECLARE_GLOBAL_VARIABLE(RADIUS_CURVE_Y3),
