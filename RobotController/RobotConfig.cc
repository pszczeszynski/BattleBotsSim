...
DEFINE_GLOBAL_VARIABLE(bool, MANUAL_AUTODRIVE, false)
...
DEFINE_GLOBAL_VARIABLE(int, BLOBS_FRAME_COUNT, 10)
DEFINE_GLOBAL_VARIABLE(bool, POSITION_NET_ENABLED, true)
...
DEFINE_GLOBAL_VARIABLE(int, HEU_FOREGROUND_MAXSIZE, 300)
...
DEFINE_GLOBAL_VARIABLE(bool, HEU_BACKGROUND_HEALING, true)
DEFINE_GLOBAL_VARIABLE(bool, HEU_FORCE_BACKGROUND_AVERAGING, false)
...
DEFINE_GLOBAL_VARIABLE(int, HEU_VEL_TO_ANGLE_MIN, 30)
DEFINE_GLOBAL_VARIABLE(int, HEU_VEL_TO_ANGLE_K, 25)
DEFINE_GLOBAL_VARIABLE(float, HEU_ROT_GAIN, 1.0f)
DEFINE_GLOBAL_VARIABLE(bool, HUE_ROBOT_CENTER_FROM_BOT, false)
DEFINE_GLOBAL_VARIABLE(float, HUE_ROBOT_CENTER_OFFSET, 20.0f)
...
DEFINE_GLOBAL_VARIABLE(bool, INTEGRATE_GYRO_VEL, true)
DEFINE_GLOBAL_VARIABLE(int, MAX_AVERAGE_DELAY_MS, 100)
DEFINE_GLOBAL_VARIABLE(int, SWITCH_COOLDOWN_MS, 500)
DEFINE_GLOBAL_VARIABLE(float, ASTAR_PP_RAD_SLOW, 60.0f)
DEFINE_GLOBAL_VARIABLE(float, ASTAR_PP_RAD_FAST, 100.0f)
DEFINE_GLOBAL_VARIABLE(float, ASTAR_PP_SPEED_FAST, 400.0f)
DEFINE_GLOBAL_VARIABLE(float, ASTAR_PP_SLOW_GAIN, 1.0f)
DEFINE_GLOBAL_VARIABLE(float, ASTAR_PP_FAST_GAIN, 0.40f)
DEFINE_GLOBAL_VARIABLE(float, ASTAR_PP_FAST_SPEED, 400.0f)
DEFINE_GLOBAL_VARIABLE(float, ASTAR_PP_MAX_CURVE_GAIN, 0.005f)
DEFINE_GLOBAL_VARIABLE(float, ASTAR_PP_TURN_SPEED_FF, 0.11f)
...
DEFINE_GLOBAL_VARIABLE(bool, ODO_OPENCV_ENABLED, true)
DEFINE_GLOBAL_VARIABLE(bool, ODO_LKFLOW_ENABLED, true)
DEFINE_GLOBAL_VARIABLE(float, NN_MIN_CONFIDENCE, 0.3)
DEFINE_GLOBAL_VARIABLE(float, TRACKER_MIN_CONFIDENCE, 0.3)
...
GlobalVariable globalVariables[] = {
    ...
    DECLARE_GLOBAL_VARIABLE(MANUAL_AUTODRIVE),
    ...
    DECLARE_GLOBAL_VARIABLE(BLOBS_FRAME_COUNT),
    DECLARE_GLOBAL_VARIABLE(POSITION_NET_ENABLED),
    ...
    DECLARE_GLOBAL_VARIABLE(HEU_FOREGROUND_MAXSIZE),
    ...
    DECLARE_GLOBAL_VARIABLE(HEU_BACKGROUND_HEALING),
    DECLARE_GLOBAL_VARIABLE(HEU_FORCE_BACKGROUND_AVERAGING),
    ...
    DECLARE_GLOBAL_VARIABLE(HEU_VEL_TO_ANGLE_MIN),
    DECLARE_GLOBAL_VARIABLE(HEU_VEL_TO_ANGLE_K),
    DECLARE_GLOBAL_VARIABLE(HEU_ROT_GAIN),
    DECLARE_GLOBAL_VARIABLE(HUE_ROBOT_CENTER_FROM_BOT),
    DECLARE_GLOBAL_VARIABLE(HUE_ROBOT_CENTER_OFFSET),
    ...
    DECLARE_GLOBAL_VARIABLE(ASTAR_PP_RAD_SLOW),
    DECLARE_GLOBAL_VARIABLE(ASTAR_PP_RAD_FAST),
    DECLARE_GLOBAL_VARIABLE(ASTAR_PP_SPEED_FAST),
    DECLARE_GLOBAL_VARIABLE(ASTAR_PP_SLOW_GAIN),
    DECLARE_GLOBAL_VARIABLE(ASTAR_PP_FAST_GAIN),
    DECLARE_GLOBAL_VARIABLE(ASTAR_PP_FAST_SPEED),
    DECLARE_GLOBAL_VARIABLE(ASTAR_PP_MAX_CURVE_GAIN),
    DECLARE_GLOBAL_VARIABLE(ASTAR_PP_TURN_SPEED_FF),
    ...
    DECLARE_GLOBAL_VARIABLE(ODO_OPENCV_ENABLED),
    DECLARE_GLOBAL_VARIABLE(ODO_HEUR_ENABLED),
    DECLARE_GLOBAL_VARIABLE(ODO_IMU_ENABLED),
    DECLARE_GLOBAL_VARIABLE(ODO_LKFLOW_ENABLED),
    DECLARE_GLOBAL_VARIABLE(NN_MIN_CONFIDENCE),
    DECLARE_GLOBAL_VARIABLE(TRACKER_MIN_CONFIDENCE),
