...
DEFINE_GLOBAL_VARIABLE(float, PP_ANGLE_OFFSET_GAIN, 0.00022f)
DEFINE_GLOBAL_VARIABLE(float, APPROACH_RAD_AT_ANGLE, 120.0f)
DEFINE_GLOBAL_VARIABLE(float, APPROACH_REF_ANGLE_DEG, 140.0f)
DEFINE_GLOBAL_VARIABLE(float, APPROACH_CURVE_EXPONENT, 0.65f)
...
GlobalVariable globalVariables[] = {
    ...
    DECLARE_GLOBAL_VARIABLE(PP_ANGLE_OFFSET_GAIN),
    DECLARE_GLOBAL_VARIABLE(APPROACH_RAD_AT_ANGLE),
    DECLARE_GLOBAL_VARIABLE(APPROACH_REF_ANGLE_DEG),
    DECLARE_GLOBAL_VARIABLE(APPROACH_CURVE_EXPONENT),
