...
namespace vietlabs.fr2
{
	...
	public class FR2_WindowAll : FR2_WindowBase, IHasCustomMenu
	{
			...
			if (tabs == null)
			{
				...
				tabs.callback = new DrawCallback()
				{
					AfterDraw = () =>
					{
						...
						if (GUI2.ToolbarToggle(ref sp1.isHorz, FR2_Icon.Panel.image, "Layout"))
						{
							sp1.CalculateWeight();
							Repaint();
						}
						
						if (GUI2.ToolbarToggle(ref sp1.splits[0].visible, FR2_Icon.Selection.image, "Show / Hide Selection"))
						{
							sp1.CalculateWeight();
							Repaint();
						}
						
						if (GUI2.ToolbarToggle(ref sp2.splits[0].visible, FR2_Icon.Scene.image, "Show / Hide Scene References"))
						{
							sp2.CalculateWeight();
							Repaint();
						}
						
						if (GUI2.ToolbarToggle(ref sp2.splits[1].visible, FR2_Icon.Asset.image, "Show / Hide Asset References"))
						{
							sp2.CalculateWeight();
							Repaint();
						}
						...
						if (GUI2.ToolbarToggle(ref sp1.splits[2].visible, FR2_Icon.Favorite.image, "Show / Hide Bookmarks"))
						{
							sp1.CalculateWeight();
							Repaint();
						}
		...
		void DrawAssetViewSettings()
		{
			...
			{
				GUI2.ToolbarToggle(ref FR2_Setting.s.displayAssetBundleName, FR2_Icon.AssetBundle.image, "Show / Hide Assetbundle Names");
				#if UNITY_2017_1_OR_NEWER
				GUI2.ToolbarToggle(ref FR2_Setting.s.displayAtlasName, FR2_Icon.Atlas.image, "Show / Hide Atlas packing tags");
				#endif
				GUI2.ToolbarToggle(ref FR2_Setting.s.showUsedByClassed, FR2_Icon.Material.image, "Show / Hide usage icons");
				GUI2.ToolbarToggle(ref FR2_Setting.s.displayFileSize, FR2_Icon.Filesize.image, "Show / Hide file size");
