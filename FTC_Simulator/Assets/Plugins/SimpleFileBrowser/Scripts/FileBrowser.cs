...
#pragma warning restore 0414
		...
		{
			get { return saveAllMatchesToggle.gameObject.activeSelf; }
			set { saveAllMatchesToggle.gameObject.SetActive(value); }
		}
		...
		{
			return ShowDialogInternal( onSuccess, onCancel, pickMode, allowMultiSelection, false, initialPath, initialFilename, title, loadButtonText, false );
		}
		...
		private static bool ShowDialogInternal( OnSuccess onSuccess, OnCancel onCancel,
												...
												string initialPath, string initialFilename, string title, string submitButtonText, bool showSaveAllMatches = false )
		{
			...
			Instance.showAutoSave = showSaveAllMatches;
